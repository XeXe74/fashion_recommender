...
def run_pipeline(pil_image, user_input):
    ...
    try:
        ...
        # Set optimal configuration directly instead of running the hyperparameter search loop
        best_alpha = 0.7
        best_top_k = 20
        ...
        medals = ["🥇", "🥈", "🥉"]
        galleries = [[], [], []]
        summary_lines = [f"**Here are your recommended outfits:**\n"] # Start the summary with a header
